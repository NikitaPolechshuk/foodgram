# Generated by Django 5.2.5 on 2025-09-06 18:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=64, null=True, unique=True, verbose_name='Уникальный слаг')),
            ],
            options={
                'verbose_name': 'Тег',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='recieps/', verbose_name='Изображение')),
                ...
                ('short_link', models.CharField(blank=True, help_text='Уникальная короткая ссылка для рецепта', max_length=10, unique=True, verbose_name='Короткая ссылка')),
