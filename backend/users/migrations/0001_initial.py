    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'Пользователь с таким email уже существует.'}, max_length=254, unique=True, validators=[django.core.validators.EmailValidator()], verbose_name='email address')),
                ('first_name', models.CharField(max_length=150, verbose_name='Имя')),
                ('last_name', models.CharField(max_length=150, verbose_name='Фамилия')),
                ('avatar', models.ImageField(blank=True, help_text='Загрузите изображение для аватара', null=True, upload_to='avatars/', verbose_name='Аватарка')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subscriber', 'author'], name='users_subsc_subscri_519a1f_idx'),
        ),
        migrations.AddIndex(
            model_name='subscription',
            index=models.Index(fields=['subscriber'], name='users_subsc_subscri_47e49a_idx'),
        ),
        migrations.AddIndex(
            model_name='subscription',
        ...
        migrations.AddIndex(
            model_name='subscription',
            index=models.Index(fields=['created'], name='users_subsc_created_97e5ae_idx'),
        ),
